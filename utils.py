...
if __name__ == "__main__":
    ...
    finding = 1
    # Read scan
    [scan,spacing,origin,transfmat] =  readMhd('Data/data0/LNDb-{:04}.mhd'.format(lnd))
    print(spacing,origin,transfmat)
    # Read segmentation mask
    [mask,spacing,origin,transfmat] =  readMhd('Data/masks/LNDb-{:04}_rad{}.mhd'.format(lnd,rad))
    print(spacing,origin,transfmat)
    # Read nodules csv
